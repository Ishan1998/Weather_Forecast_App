...
const cityValue = document.querySelector('.searching input');
...
updateWeatherApp = (city) => {
  ...
  if (isDayTime(imageName)) {
    console.log('day');
    timeImage.setAttribute('src', 'static/images/day_image.svg');
    ...
    console.log('night');
    timeImage.setAttribute('src', 'static/images/night_image.svg');
